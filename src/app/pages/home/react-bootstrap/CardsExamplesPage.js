    ...
    return (
      <>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <CodeExample jsCode={jsCode7} beforeCodeTitle="Image caps">
              <div className="kt-section">
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <CodeExample jsCode={jsCode4} beforeCodeTitle="List Groups">
              <div className="kt-section">
                <span className="kt-section__sub">
        ...
        <div className="row">
          <div className="col-md-6">
            <CodeExample jsCode={jsCode5} beforeCodeTitle="Kitchen Sink">
              <div className="kt-section">
                <span className="kt-section__sub"></span>
                <div className="kt-separator kt-separator--dashed"></div>
                <Card style={{ width: "18rem" }}>
          ...
          <div className="col-md-6">
            <CodeExample jsCode={jsCode6} beforeCodeTitle="Header and Footer">
              <div className="kt-section">
                <span className="kt-section__sub">
        ...
        <div className="row">
          <div className="col-md-6">
            <CodeExample jsCode={jsCode2} beforeCodeTitle="Body">
              <div className="kt-section">
                <span className="kt-section__sub">
          ...
          <div className="col-md-6">
            <CodeExample jsCode={jsCode8} beforeCodeTitle="Image Overlays">
              <div className="kt-section">
                <span className="kt-section__sub">
        ...
        <div className="row">
          <div className="col-md-6">
            <CodeExample jsCode={jsCode11} beforeCodeTitle="Border Color">
              <div className="kt-section">
                <span className="kt-section__sub"></span>
                <div className="kt-separator kt-separator--dashed"></div>
                <>
          ...
          <div className="col-md-6">
            <CodeExample jsCode={jsCode10} beforeCodeTitle="Background Color">
              <div className="kt-section">
                <span className="kt-section__sub">
        ...
        <div className="row">
          <div className="col-md-6">
            <CodeExample jsCode={jsCode9} beforeCodeTitle="Navigation">
              <div className="kt-section">
                <span className="kt-section__sub">
          ...
          <div className="col-md-6">
            <CodeExample jsCode={jsCode12} beforeCodeTitle="Card Groups">
              <div className="kt-section">
                <span className="kt-section__sub"></span>
                <div className="kt-separator kt-separator--dashed"></div>
                <CardGroup>
        ...
        <div className="row">
          <div className="col-md-6">
            <CodeExample jsCode={jsCode13} beforeCodeTitle="Card Deck">
              <div className="kt-section">
                <span className="kt-section__sub"></span>
                <div className="kt-separator kt-separator--dashed"></div>
                <CardDeck>
          ...
          <div className="col-md-6">
            <CodeExample jsCode={jsCode14} beforeCodeTitle="Card Columns">
              <div className="kt-section">
                <span className="kt-section__sub"></span>
                <div className="kt-separator kt-separator--dashed"></div>
                <CardColumns>
